...
{
    public class DateKey : IComparable<DateKey>, IEquatable<DateKey>
    {
        public int dd;
        public int mm;
        public int yy;
        public DateKey(int ind, int inm, int iny)
        {
            dd = ind;
            mm = inm;
            yy = iny;
        ...
        public bool Equals(DateKey obj)
        {
    ...
    public class ProcessedReq : IComparable<ProcessedReq>, IEquatable<ProcessedReq>
    {
        ...
        public ProcessedReq(DateKey key, string n, string w, string c, string p)
        {
            Key = key;
            num = n;
            worker = w;
        ...
        {
            return Key.dd.ToString() + "." + Key.mm.ToString() + "." + Key.yy.ToString() + " " + problem + " " + customer + " " + worker + " " + num;
        }
        ...
        {
            return (this.Key.dd == obj.Key.dd && this.Key.mm == obj.Key.mm && this.Key.yy == obj.Key.yy && this.worker == obj.worker && this.customer == obj.customer && this.problem == obj.problem);
        }
